...
class AdminManagePlugin extends AppController {
	...
	private function init() {
		...
		// Set the page title
		$this->parent->structure->set("page_title", Language::_("FeedReaderManagePlugin." . Loader::fromCamelCase($this->action ? $this->action : "index") . ".page_title", true));
	}
	...
	public function add() {
		...
		$vars = array('plugin_id'=>$this->plugin_id);
