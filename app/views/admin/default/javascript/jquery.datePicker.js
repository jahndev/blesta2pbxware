...
//								$('<a href="#" class="selecteee">aaa</a>'),
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										$('<a class="dp-nav-prev-year" href="#" title="' + $.dpText.TEXT_PREV_YEAR + '">&laquo;</a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '">&lsaquo;</a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										$('<a class="dp-nav-next-year" href="#" title="' + $.dpText.TEXT_NEXT_YEAR + '">&raquo;</a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '">&rsaquo;</a>')
											.bind(
												'click',
												function()
												{
